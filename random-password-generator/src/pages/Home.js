...
export default function Home() {
  ...
  const generatePassword = () => {
    ...
    if (includeLowercase === false && includeNumbers === false && includeSpecialChars === false && includeUppercase === false) {
        alert('Atleast one option should be chosen');
    } else {
        let password = '';
  ...
  return (
    <div className="home-root">
        <div className="generated-password">
            Your random password is <span className='gen-pass'>{password}</span>
        </div>
        <div className='length-of-pass'>
